...
create table if not exists Equipe_fortes(
Funcao varchar(45) not null,
ID_Funcionarios int not null,
ID_Departamentos int not null,
constraint Form_fort foreign key (Funcao) references Equipe(Funcao),
constraint Fort_Form foreign key (ID_Funcionarios) references Fortes(ID_Funcionarios),
constraint Dep_Fort foreign key (ID_Departamentos) references Fortes(ID_Departamentos)
);
